...
<form class="p-4">
  ...
  <input name="name" bind:value={name} type="text" autocomplete="off" class="p-2 border-2 border-indigo-200 rounded-md mb-6 w-full"/>
  ...
  <input name="description" bind:value={description} autocomplete="off" type="text" class="p-2 border-2 border-indigo-200 rounded-md mb-6 w-full"/>
